...
(defun show-usage ()
  ...
  (format t "~%")
  (format t "Examples:~%")
  (format t "  sbcl --script sexp-edit.lisp list src/server/commands.lisp~%")
  (format t "  sbcl --script sexp-edit.lisp count src/server/commands.lisp~%")
  (format t "  sbcl --script sexp-edit.lisp show src/server/commands.lisp 5~%")
  (format t "  sbcl --script sexp-edit.lisp delete src/server/commands.lisp 10 /tmp/out.lisp~%")
  (format t "  sbcl --script sexp-edit.lisp replace src/server/commands.lisp 3 '(defvar *test* 42)' /tmp/out.lisp~%"))
