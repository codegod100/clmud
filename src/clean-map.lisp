...
(defun clean-adjacency-map (current-room-id &optional vehicle-type)
...
(defun clean-map-render (current-room-id &optional vehicle-type)
  "Render clean 2-level adjacency map."
  (let* ((info (clean-adjacency-map current-room-id vehicle-type))
